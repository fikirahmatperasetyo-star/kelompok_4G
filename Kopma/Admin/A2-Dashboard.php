...
// --- PERHITUNGAN OTOMATIS UNTUK KARTU DASHBOARD ADMIN ---
...
// --- QUERY PRODUK TERLARIS (4 Minggu Terakhir) ---
...
// Menghitung total seluruh data pesanan untuk menentukan jumlah maksimal halaman
$q_total_data = $conn->query("SELECT COUNT(*) as total FROM pesanan");
$row_total = $q_total_data->fetch_assoc();
$total_data = $row_total['total'];
$total_halaman = ceil($total_data / $limit);

// --- QUERY TABEL RIWAYAT TRANSAKSI (ADMIN PANTAU SEMUA STATUS, DENGAN LIMIT & OFFSET) ---
$result = $conn->query("SELECT * FROM pesanan ORDER BY waktu_pesan DESC LIMIT $limit OFFSET $offset");
?>
...
<head>
    ...
    <style>
        ...
        .modal-content { background-color: #fff; margin: 10% auto; padding: 25px; border-radius: 10px; width: 50%; max-width: 600px; box-shadow: 0 5px 15px rgba(0,0,0,0.3); position: relative; max-height: 85vh; overflow-y: auto;}
...
<div class="container">
    ...
    <main class="main-content">
        <header>
            <h1>Dashboard & Pengawasan Transaksi</h1>
        </header>
        ...
        <section class="sales-data-section content-box">
             <div class="box-header">
                <h3>Riwayat & Pengawasan Transaksi</h3>
            </div>
                        ...
                        <td>
                            ...
                            <div id="modal-<?= htmlspecialchars($row['kode_pesanan']); ?>" class="modal" style="white-space: normal; text-align: left;">
                                <div class="modal-content">
                                    ...
                                    <h2 style="color: #3c8a55; margin-bottom: 10px;">Detail Transaksi</h2>
                                    ...
                                    <div style="background: #f9f9f9; padding: 15px; border-radius: 8px; margin-bottom: 15px;">
                                        ...
                                        <?php if(!empty($row['tanggal_pengambilan']) && $row['tanggal_pengambilan'] != '0000-00-00'): ?>
                                            <p><strong>Tgl Transaksi:</strong> <span style="color: red; font-weight: bold;"><?= date('d-m-Y', strtotime($row['tanggal_pengambilan'])); ?></span></p>
                                        <?php endif; ?>
